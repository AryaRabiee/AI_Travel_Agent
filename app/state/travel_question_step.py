...
def next_travel_question():
    ...
    if user_profile["step"] == 2:
        return " (برای خروج از این حالت 0 را وارد کنید) به چه نوع جاهایی علاقه‌مندید؟ (تاریخی، طبیعت، شهری...)"
    if user_profile["step"] == 3:
        return " (برای خروج از این حالت 0 را وارد کنید) بودجه تقریبی شما چقدره؟"
    if user_profile["step"] == 4:
        return " (برای خروج از این حالت 0 را وارد کنید) علاقه‌مندی خاصی دارید؟ (غذا، خرید، کوه‌نوردی...)"
